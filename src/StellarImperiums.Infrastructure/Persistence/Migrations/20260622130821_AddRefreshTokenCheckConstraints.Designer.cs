...
namespace StellarImperiums.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260622130821_AddRefreshTokenCheckConstraints")]
    partial class AddRefreshTokenCheckConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StellarImperiums.Domain.Tokens.RefreshToken", b =>
                {
                    ...
                    b.ToTable("jeton_rafraichissement", null, t =>
                        {
                            t.HasCheckConstraint("ck_jeton_rafraichissement_dates_coherentes", "expire_le > cree_le");
                        });
                });
